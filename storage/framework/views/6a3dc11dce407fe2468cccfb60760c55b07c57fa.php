                        ...
                        <form method="POST" class="steps-validation wizard-notification"
                            ...
                            <fieldset>
                                ...
                                <?php endif; ?>
                                    ...
                                    <?php if(isset($configuration->guest_user) && $configuration->guest_user == 1): ?>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="firstName3">
                                                    <?php echo app('translator')->get("$string_file.guest_user_country"); ?>
                                                </label>
                                                <?php echo e(Form::select("guest_user_country_id",$countries,old('guest_user_country_id',$configuration->guest_user_country_id),["class"=>"form-control"])); ?>

                                                <?php if($errors->has('guest_user_country_id')): ?>
                                                    <label class="danger"><?php echo e($errors->first('guest_user_country_id')); ?></label>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                ...
                                <?php endif; ?>
                                <?php if(isset($configuration->social_signup) && $configuration->social_signup == 1): ?>
                                    <br>
                                    <h5 class="form-section">
                                        <i class="fa fa-taxi"></i> <?php echo app('translator')->get("$string_file.social_signup_config"); ?>
                                    </h5>
                                    <hr>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="google_signup_key">
                                                    <?php echo app('translator')->get("$string_file.google_signup_key"); ?><span
                                                            class="text-danger">*</span>
                                                </label>
                                                <input type="text" class="form-control"
                                                       id="google_signup_key"
                                                       name="google_signup_key"
                                                       value="<?php echo e($configuration->google_signup_key); ?>"
                                                       required>
                                                <?php if($errors->has('google_signup_key')): ?>
                                                    <label class="danger"><?php echo e($errors->first('google_signup_key')); ?></label>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="twilio_service_id">
                                                    <?php echo app('translator')->get("$string_file.facebook_signup_key"); ?><span
                                                            class="text-danger">*</span>
                                                </label>
                                                <input type="text" class="form-control"
                                                       id="facebook_signup_key"
                                                       name="facebook_signup_key"
                                                       value="<?php echo e($configuration->facebook_signup_key); ?>"
                                                       required>
                                                <?php if($errors->has('facebook_signup_key')): ?>
                                                    <label class="danger"><?php echo e($errors->first('facebook_signup_key')); ?></label>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/random/generalconfiguration.blade.php ENDPATH**/ ?>