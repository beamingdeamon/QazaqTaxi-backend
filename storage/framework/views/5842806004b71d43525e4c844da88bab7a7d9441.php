                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification" id="countryForm"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control"
                                                name="document[]"
                                                id="document"
                                                data-placeholder="<?php echo app('translator')->get("$string_file.select"); ?>"
                                                multiple="multiple">
                        ...
                        <?php if($carpooling_enable): ?>
                            ...
                            <h5><i class="wb-cash"></i> <?php echo app('translator')->get('common.commission'); ?> <?php echo app('translator')->get('common.configuration'); ?></h5><hr>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/country/create.blade.php ENDPATH**/ ?>