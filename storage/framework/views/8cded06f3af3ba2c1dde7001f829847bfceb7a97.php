            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                        ...
                        <div class="col-md-6">
                            <div class="card" style="width:50vh;height:110px;border:1px solid darkcyan">
                                <h3 class="panel-title">
                                    <span><?php echo app('translator')->get("common.wallet"); ?> <?php echo app('translator')->get("common.balance"); ?> </span>
                                </h3>
                                <?php if(!empty($user->CountryArea)): ?>
                                    <div class="card-body">
                                        <p class="card-text"><?php echo e($user->CountryArea->Country->isoCode); ?> <span><?php echo e($user ?  $user->wallet_balance : "0.0"); ?></span></p>
                                    </div>
                                <?php else: ?>
                                    <div class="card-body">
                    ...
                    <!--<?php if($carpooling_enable): ?>-->
                        <!--    <div class="col-md-6">-->
                        <!--        <div class="card" style="width:50vh;height:110px;border:1px solid darkcyan">-->
                    <!--            <h3 class="panel-title"><span><?php echo app('translator')->get("common.hold"); ?> <?php echo app('translator')->get("common.amount"); ?></span>-->
                        <!--            </h3>-->
                    <!--            <?php if(!empty($user->CountryArea)): ?>-->
                        <!--                <div class="card-body">-->
                    <!--                    <p>  <?php echo e($user->CountryArea->Country->isoCode.' '.$hold_amount); ?></p>-->
                        <!--                </div>-->
                        <!--            <?php else: ?>-->
                        <!--                <div class="card-body">-->
                        <!--                    <p>0.0</p>-->
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/user/wallet.blade.php ENDPATH**/ ?>