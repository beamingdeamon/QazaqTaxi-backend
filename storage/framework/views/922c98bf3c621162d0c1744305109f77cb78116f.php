    ...
    <div class="page">
        <div class="page-content">
            ...
            <div class="panel panel-bordered">
                ...
                <?php $id = isset($data['category']['id']) ? $data['category']['id'] : NULL; ?>
                <div class="panel-body container-fluid">
                    ...
                    <div class="row">
                        ...
                        <?php if($data['category_type_view']): ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="status">
                                        <?php echo app('translator')->get("$string_file.category_type"); ?>
                                        <span class="text-danger">*</span>
                                    </label>
                                    <?php echo Form::select('category_type',$data['arr_category_type'],old('status',isset($data['category']['category_type']) ? $data['category']['category_type'] : NULL),['id'=>'','class'=>'form-control','required'=>true]); ?>

                                    <?php if($errors->has('category_type')): ?>
                                        <label class="text-danger"><?php echo e($errors->first('category_type')); ?></label>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/category/form.blade.php ENDPATH**/ ?>