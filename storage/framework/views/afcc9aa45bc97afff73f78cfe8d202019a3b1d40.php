                    ...
                    <form method="POST" class="steps-validation wizard-notification"  enctype="multipart/form-data" action="<?php echo e(route('countryareas.save',$id)); ?>" id="country_area_form">
                        ...
                        <div class="row">
                            ...
                            <?php endif; ?>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="location3"><?php echo app('translator')->get("$string_file.driver"); ?> <?php echo app('translator')->get("$string_file.personal_document"); ?><span class="text-danger">*</span></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/area/form-step1.blade.php ENDPATH**/ ?>