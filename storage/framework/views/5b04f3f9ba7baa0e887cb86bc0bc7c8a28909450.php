                ...
                <div class="panel-body container-fluid">
                    ...
                    <table id="customDataTable" class="display nowrap table table-hover table-striped w-full"
                        ...
                        <?php $__currentLoopData = $referral_systems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $refer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($sr); ?></td>
                                <td><?php echo e($refer->Country->CountryName); ?></td>
                                <td><?php echo e($refer->CountryArea->CountryAreaName); ?></td>
                                <td>
                                ...
                                <?php if(Auth::user('merchant')->can('edit_refer') || Auth::user('merchant')->can('delete_refer')): ?>
                                    <td>
                                        ...
                                        <?php endif; ?>
                                        <?php if(Auth::user('merchant')->can('delete_refer') && $refer->status != 4 && $delete_permission): ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/referral_system/index.blade.php ENDPATH**/ ?>