        ...
        <div class="col-lg-6 col-xs-12">
            ...
            <div class="card my-2 shadow  bg-white h-240">
                ...
                <div class="row p-3 ml-30">
                    ...
                    <div class="col-md-8 col-xs-6">
                        <p>
                            <?php echo convertTimeToUSERzone($order->created_at, $order->CountryArea->timezone, null, $order->Merchant,2); ?>
                ...
                <div class="row p-3 ml-30">
                    <div class="col-md-4 col-xs-6 text-success">
                        <i class="icon fa-calendar fa-2x text-gray-300"></i><?php echo app('translator')->get("$string_file.deliver_date"); ?>
                    </div>
                    <div class="col-md-8 col-xs-6">
...
<?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/common-view/order-detail.blade.php ENDPATH**/ ?>