        ...
        <div class="panel panel-bordered">
            <header class="panel-heading">
                ...
                <h3 class="panel-title">
                    ...
                    <?php echo app('translator')->get("$string_file.edit"); ?> <?php echo app('translator')->get("$string_file.reward_points"); ?>
                </h3>
            </header>
            <div class="panel-body container-fluid">
                <section id="validation">
                    <form method="POST" class="steps-validation wizard-notification" action="<?php echo e(route('merchant.rewardSystem.update',$reward_system->id)); ?>">
                        <?php echo csrf_field(); ?>
                        <fieldset>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="application" id="application" disabled>
                                            ...
                                            <option value="1" <?php if($reward_system->application == 1): ?> selected <?php endif; ?>><?php echo app('translator')->get("$string_file.user"); ?></option>
                                            
                                        </select>
                                        <span class="text-danger"><?php echo e($errors->first('application')); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4 <?php if(empty($reward_system->country_id)): ?> custom-hidden  <?php endif; ?>" id="country_div">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="country" disabled>
                                            ...
                                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($country->id); ?>" <?php echo e((old('country',$reward_system->country_id) == $country->id) ? ' selected' : ''); ?>>
                                ...
                                <div class="col-md-4 <?php if(empty($reward_system->country_area_id)): ?> custom-hidden <?php endif; ?>" id="country_area_div">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="country_area" disabled>
                                            ...
                                            <?php $__currentLoopData = $country_areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($area->id); ?>"
                                                        <?php echo e((old('country_area',$reward_system->country_area_id) == $area->id) ? ' selected' : ''); ?>
                            ...
                            <div <?php if($reward_system->trip_expense_reward != 1): ?> id="trip_expenses_div" <?php endif; ?>>
                                <hr>
                                <div class="row" >
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="trip_expenses" onchange="switchDisabled(this.value , 'expenses-switch')">
                                                ...
                                                <option value="1" <?php echo e((old('trip_expenses',$reward_system->trip_expense_reward) == 1) ? 'selected' : ''); ?>> <?php echo app('translator')->get("$string_file.enable"); ?> </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" step="0.01" max="1000000" class="form-control expenses-switch" name="per_point_amount" value="<?php echo e(old('per_point_amount',$reward_system->amount_per_points)); ?>"
                                              <?php echo e((old('trip_expenses',$reward_system->trip_expense_reward) == 1) ? '' : 'disabled'); ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" max="1000000" class="form-control expenses-switch" name="expenses_expire_in_days" value="<?php echo e(old('expenses_expire_in_days',$reward_system->expenses_expire_in_days)); ?>"
                                              <?php echo e((old('trip_expenses',$reward_system->trip_expense_reward) == 1) ? '' : 'disabled'); ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/reward/edit.blade.php ENDPATH**/ ?>