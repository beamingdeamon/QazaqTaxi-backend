            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title"><i class="far fa-car" aria-hidden="true"></i>
                        <?php echo app('translator')->get("$string_file.on_going"); ?> <?php echo app('translator')->get("$string_file.ride"); ?>
                    </h3>
                </header>
                <div class="panel-body container-fluid">
                    <form action="<?php echo e(route('merchant.carpool.active.rides.search')); ?>" method="get">
                ...
                <table id="customDataTable" class="display nowrap table table-hover table-striped w-full"
                    ...
                    <?php $sr = $active_ride->firstItem() ?>
                    <?php $__currentLoopData = $active_ride; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $active): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($sr); ?></td>

                        <td><?php echo e($active->id ? : ''); ?></td>

                        <td><?php echo e($active->carpooling_ride_id ? : ''); ?></td>
                        <td><?php echo e($active->carpooling_ride_detail_id ? : ''); ?></td>
                        <td>
                            <?php echo e(ucwords($active->user->first_name)." ".$active->user->last_name); ?>

                            <br>
                            <?php echo e($active->user->UserPhone ? : ''); ?>

                            <br>
                            <?php echo e($active->user->email ? : ''); ?>


                        </td>
                        <td>
                            <?php echo e(ucwords($active->CarpoolingRide->user->first_name)." ".$active->CarpoolingRide->user->last_name); ?>

                            <br>
                            <?php echo e($active->CarpoolingRide->user->UserPhone ? : ''); ?>

                            <br>
                            <?php echo e($active->CarpoolingRide->user->email ? : ''); ?>

                        </td>
                        <td><?php echo e($active->CarpoolingRide->CountryArea->CountryAreaName); ?></td>
                        <td><?php echo e($active->promo_code); ?></td>
                      

                        <td><?php echo e(date('Y-m-d h:s:i',$active->ride_timestamp)); ?></td>
                        <td> <a href="<?php echo $active->CarpoolingRideDetail->map_image; ?>"
                                target="_blank"><?php echo app('translator')->get("$string_file.view"); ?> <?php echo app('translator')->get("$string_file.map"); ?></a></td>
                        <td><?php echo e($active->payment_status == 0 ? trans("$string_file.pending") : ($active->payment_status == 1 ? trans("$string_file.success") : ' ')); ?></td>
                        <td><?php echo e($active->ac_ride == 0 ? trans("$string_file.no") : ($active->ac_ride == 1 ? trans("$string_file.yes") : ' ')); ?></td>
                        <td>
                            <a href="<?php echo e(route('merchant.offer.rides.user.details',['id'=>$active->id])); ?>"
                    ...
                    <?php echo $__env->make('merchant.shared.table-footer', ['table_data' => $active_ride, 'data' =>$data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </table>
            </div>
            </div>
        </div>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/car-pool-ride-management/active-ride.blade.php ENDPATH**/ ?>