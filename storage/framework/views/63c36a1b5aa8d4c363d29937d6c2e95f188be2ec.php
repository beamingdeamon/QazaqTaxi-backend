...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        let infowindow;
        function createMap(){
            map = new mapgl.Map('context-menu', {
                zoom: 5,
                center: [70.060249,48.200192],
                key: '896f3963-4c91-4ce7-9a61-6f91f3ff7ebd',
        ...
        function drawMarkers(markers){
            markers.forEach(marker => {
                let new_marker = new mapgl.Marker(map, {
                    coordinates: [marker.marker_longitude, marker.marker_latitude],
