                ...
                <ul class="site-menu" data-plugin="menu">
                    ...
                    <li class="site-menu-item has-sub">
                        ...
                        <ul class="site-menu-sub">
                            ...
                            <li class="site-menu-item">
                                <a class="animsition-link"
                                   href="<?php echo e(route('business-segment.pending-order-delivery')); ?>">
                                    <span class="site-menu-title"><?php echo app('translator')->get("$string_file.pending_order_delivery"); ?> </span>
                                </a>
                            </li>
                            <li class="site-menu-item">
...
<?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/business-segment/element/sidebar.blade.php ENDPATH**/ ?>