                        ...
                        <?php $__currentLoopData = $arr_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <a target="_blank" title=""
                                           href="<?php echo e(route('business-segment.order.accept',$order->id)); ?>" class="btn btn-sm btn-info menu-icon btn_money action_btn">
                                            <span class="fa fa-check" title="<?php echo app('translator')->get("$string_file.accept"); ?>"></span>
                                        </a>
                                        <a target="_blank" title="<?php echo app('translator')->get("$string_file.reject"); ?>"
                                           href="<?php echo e(route('business-segment.order-reject',$order->id)); ?>" class="btn btn-sm btn-danger menu-icon btn-edit action_btn"><span class="fa fa-edit"></span>
                                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('business-segment.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/business-segment/order/today-order.blade.php ENDPATH**/ ?>