...
<div id="floating-panel">
    <input type="hidden" id="vehicle_map_icon" value="<?php echo e(view_config_image($booking->VehicleType->vehicleTypeMapImage)); ?>">
    <table cellpadding="0" cellspacing="0">
        <tr>
            <td width="100" align="center">
                <img id="profile_pic" src="<?php echo e(get_image($booking->Driver->profile_image,'driver',$booking->merchant_id)); ?>" width="70" height="70">
            </td>
            <td width="240">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td height="30"><strong><?php echo app('translator')->get("$string_file.email"); ?> : </strong><?php echo e($booking->Driver->email); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="30"><strong><?php echo app('translator')->get("$string_file.phone_number"); ?>: </strong> <span><?php echo e($booking->Driver->phoneNumber); ?></span></td>
                    </tr>
                </table>
            </td>
        </tr>
...
</html><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/map.blade.php ENDPATH**/ ?>