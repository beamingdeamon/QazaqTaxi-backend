                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(Auth::user('merchant')->can('edit_area')): ?>
                                        ...
                                        <?php if($self_pickup): ?>
                                            <a href="<?php echo e(route('countryareas.add.step5',$area->id)); ?>"
                                               data-original-title="<?php echo app('translator')->get("$string_file.self_pickup"); ?>" data-toggle="tooltip"
                                               data-placement="top"
                                               class="btn btn-sm btn-primary menu-icon btn_edit action_btn">

                                                <img src="<?php echo e(asset('basic-images/self-pickup.png')); ?>" height="20" width="20">
                                            </a>
                                          <?php endif; ?>
                                        <?php endif; ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/area/index.blade.php ENDPATH**/ ?>