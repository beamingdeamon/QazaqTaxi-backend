                                        ...
                                        <?php if($driver->login_logout == 1): ?>
                                            <?php if($driver->online_offline == 1): ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    ?>
                                                    <?php if($driver->last_location_update_time >= $location_updated_last_time): ?>
                                                        <span class="badge badge-success"><?php echo app('translator')->get("$string_file.online"); ?></span>
                                                    <?php else: ?>
                                                        <span class="badge badge-secondary"><?php echo app('translator')->get("$string_file.location_update_expire"); ?></span>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            <?php else: ?>
                                ...
                                <td>
                                    <div class="button-margin">
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <?php if(Auth::user('merchant')->can('delete_drivers') && $delete_permission): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/driver/index.blade.php ENDPATH**/ ?>