                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification"
                        ...
                        <div class="form-actions d-flex flex-row-reverse p-2">
                            <?php if(Auth::user('merchant')->can('edit-account-types') && $edit_permission): ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/account_types/edit.blade.php ENDPATH**/ ?>