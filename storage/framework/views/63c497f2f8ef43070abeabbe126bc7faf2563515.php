                                ...
                                <?php if($price_card_for == 2): ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            'placeholder'=>'','min'=>0,'step'=>$data['step_value']]); ?>
                            ...
                            <div class="row" id="row_id_<?php echo e($i); ?>">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::number('slab_amount[]',old('slab_amount[]',isset($detail['slab_amount']) ? $detail['slab_amount'] : ''),['class'=>'form-control','id'=>'slab_amount','required'=>$required,'min'=>0,'step'=>$data['step_value']]); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::number('charges',old('charges',isset($time_charges->charges) ? $time_charges->charges : NULL),['class'=>'form-control','id'=>'charges','min'=>0,'step'=>$data['step_value']]); ?>
        ...
        $(document).ready(function (e) {
            $(document).on("click", "#add_more_slot", function (e) {
                ...
                var new_row = '<div class="row" id="row_id_' + row_id + '"><div class="col-md-2"><div class="form-group">' +
                    ...
                    '<span class="text-danger"><?php echo e($mandatory_astrick); ?></span>' +
                    '</label>' +
                    '<?php echo Form::number('cart_amount[]',old('cart_amount[]',''),['class'=>'form-control','id'=>'cart_amount','placeholder'=>'','required'=>$required,'step'=>$data['step_value'],'min'=>0]); ?>' +
                    '<?php if($errors->has('slab_amount')): ?>' +
                    '<span class="help-block"><strong><?php echo e($errors->first('slab_amount')); ?></strong></span>' +
                    '<?php endif; ?>' +
                    '</div></div>' +
                    ...
                    '<span class="text-danger"><?php echo e($mandatory_astrick); ?></span>' +
                    '</label>' +
                    '<?php echo Form::number('slab_amount[]',old('slab_amount[]',''),['class'=>'form-control','id'=>'slab_amount','required'=>$required,'step'=>$data['step_value'],'min'=>0]); ?>' +
                    '<?php if($errors->has('slab_amount')): ?>' +
                    '<span class="help-block"><strong><?php echo e($errors->first('slab_amount')); ?></strong></span>' +
                    '<?php endif; ?>' +
                    '</div>' +
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/food-grocery-pricecard/form.blade.php ENDPATH**/ ?>