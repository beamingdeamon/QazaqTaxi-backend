                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo e(route('vehiclemake.store')); ?>">
                    ...
                    <div class="modal-body">
                        ...
                        <label>  <?php echo app('translator')->get("$string_file.logo"); ?>
                            <span class="text-danger">*</span> </label><span style="color: blue">(<?php echo app('translator')->get("$string_file.size"); ?>)</span><i
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qazaq/public_html/admin.qazaq.taxi/ms-v3/resources/views/merchant/vehiclemake/index.blade.php ENDPATH**/ ?>