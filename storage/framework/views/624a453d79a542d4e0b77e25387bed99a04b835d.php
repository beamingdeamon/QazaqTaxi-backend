                    ...
                    <section id="validation">
                        <form method="POST" class="steps-validation wizard-notification"
                            ...
                            <?php if(in_array('CARPOOLING',$merchant_segment)): ?>
                                <h5 class="form-section"><i
                                            class="fa fa-truck"></i> <?php echo app('translator')->get("carpooling.carpooling"); ?> <?php echo app('translator')->get("common.configuration"); ?>
                                </h5>
                                <hr>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-capitalize"> <?php echo app('translator')->get("$string_file.drop"); ?> <?php echo app('translator')->get("common.location"); ?> <?php echo app('translator')->get("common.radius"); ?></label>
                                            <input name="drop_location_radius" class="form-control"
                                                   value="<?php echo e($car_pooling_Configuration ? $car_pooling_Configuration->drop_location_radius  : ''); ?>"
                                                   placeholder="<?php echo app('translator')->get('common.enter'); ?> <?php echo app('translator')->get("$string_file.drop"); ?> <?php echo app('translator')->get("common.location"); ?> <?php echo app('translator')->get("common.radius"); ?>  <?php echo app('translator')->get("common.in"); ?>  <?php echo app('translator')->get("common.km"); ?>">
                                            <?php if($errors->first('drop_location_radius')): ?>
                                                <span class="text-danger"><?php echo e($errors->first('drop_location_radius')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-capitalize"> <?php echo app('translator')->get("common.number"); ?> <?php echo app('translator')->get("common.of"); ?> <?php echo app('translator')->get("$string_file.drop"); ?></label>
                                            <input name="number_of_drops" class="form-control"
                                                   value="<?php echo e($car_pooling_Configuration ? $car_pooling_Configuration->number_of_drops  : ''); ?>"
                                                   placeholder="<?php echo app('translator')->get('common.enter'); ?> <?php echo app('translator')->get("common.number"); ?> <?php echo app('translator')->get("common.of"); ?> <?php echo app('translator')->get("$string_file.drop"); ?>">
                                            <?php if($errors->first('number_of_drops')): ?>
                                                <span class="text-danger"><?php echo e($errors->first('number_of_drops')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-capitalize"> <?php echo app('translator')->get("common.number"); ?> <?php echo app('translator')->get("common.of"); ?> <?php echo app('translator')->get("$string_file.ride"); ?> <?php echo app('translator')->get("common.to"); ?> <?php echo app('translator')->get("common.show"); ?> <?php echo app('translator')->get("common.user"); ?></label>
                                            <input name="no_of_rides_to_show_user" class="form-control"
                                                   value="<?php echo e($car_pooling_Configuration ?  $car_pooling_Configuration->no_of_rides_to_show_user  : ''); ?>"
                                                   placeholder="<?php echo app('translator')->get('common.enter'); ?> <?php echo app('translator')->get("common.number"); ?> <?php echo app('translator')->get("common.of"); ?> <?php echo app('translator')->get("$string_file.rides"); ?> <?php echo app('translator')->get("common.to"); ?> <?php echo app('translator')->get("common.show"); ?> <?php echo app('translator')->get("common.user"); ?>">
                                            <?php if($errors->first('no_of_rides_to_show_user')): ?>
                                                <span class="text-danger"><?php echo e($errors->first('no_of_rides_to_show_user')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="text-capitalize"> <?php echo app('translator')->get("common.user"); ?> <?php echo app('translator')->get("$string_file.ride"); ?> <?php echo app('translator')->get("common.start"); ?> <?php echo app('translator')->get("common.time"); ?>
                                            <span class="text-danger">*</span></label>
                                        <div class="input-group mb-3">
                                            <input type="text" name="user_ride_start_time" id="ride"
                                                   class="form-control" aria-label="Text input with checkbox"
                                                   value="<?php echo e($car_pooling_Configuration ?  $car_pooling_Configuration->user_ride_start_time  : ''); ?>"
                                                   placeholder="<?php echo app('translator')->get('common.enter'); ?> <?php echo app('translator')->get("common.time"); ?> <?php echo app('translator')->get("common.in"); ?> <?php echo app('translator')->get("common.minute"); ?>">
                                            <?php if($errors->first('user_ride_start_time')): ?>
                                                <span class="text-danger"><?php echo e($errors->first('user_ride_start_time')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="text-capitalize"> <?php echo app('translator')->get("common.user"); ?> <?php echo app('translator')->get("common.document"); ?> <?php echo app('translator')->get("common.reminder_expire_doc"); ?>
                                            <span class="text-danger">*</span></label>
                                        <div class="input-group mb-3">

                                            <input type="text" name="user_document_reminder_time" id="document"
                                                   class="form-control" aria-label="Text input with checkbox"
                                                   placeholder="<?php echo app('translator')->get('common.enter'); ?> <?php echo app('translator')->get("common.time"); ?> <?php echo app('translator')->get("common.in"); ?> <?php echo app('translator')->get("common.days"); ?>"
                                                   value="<?php echo e($car_pooling_Configuration ?  $car_pooling_Configuration->user_document_reminder_time  : ''); ?>">
                                            <?php if($errors->first('user_document_reminder_time')): ?>
                                                <span class="text-danger"><?php echo e($errors->first('user_document_reminder_time')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                            ...
                            <?php endif; ?>
                            <br>
                           <?php if($food_grocery || $all_food_grocery_clone): ?>
                            <h5 class="form-section"><i
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/random/bookingconfiguration.blade.php ENDPATH**/ ?>