        ...
        <div>
            <div>
                <ul class="site-menu" data-plugin="menu" id="myMenu">
                    ...
                    <?php endif; ?>
                    <?php if((in_array('TAXI',$merchant_segment) && Auth::user('merchant')->can('TAXI')) || (in_array('DELIVERY',$merchant_segment) && Auth::user('merchant')->can('DELIVERY'))): ?>
                        <?php if(($config->company_admin == 1 || Auth::user('merchant')->hotel_active == 1 || $config->corporate_admin == 1 || Auth::user('merchant')->franchisees_active == 1 || $config->driver_agency == 1) && ( Auth::user('merchant')->hasAnyPermission(['taxi_company','taxi_company_DELIVERY','corporate','hotel','franchisee','driver_agency']))): ?>
                            <li class="site-menu-category" id="general-title"><?php echo app('translator')->get("$string_file.associates"); ?></li>
                            <?php if((Auth::user('merchant')->can('taxi_company') || Auth::user('merchant')->can('taxi_company_DELIVERY')) && $config->company_admin == 1): ?>
                                <li class="site-menu-item">
                                    <a href="<?php echo e(route('merchant.taxi-company')); ?>">
                                        <i class="site-menu-icon fa-handshake-o" aria-hidden="true"></i>
                                        <span class="site-menu-title"><?php echo app('translator')->get("$string_file.taxi_company"); ?> <?php echo app('translator')->get("$string_file.panels"); ?></span>
                                    </a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <?php if((Auth::user('merchant')->can('corporate') || Auth::user('merchant')->can('corporate_DELIVERY')) && $config->corporate_admin == 1): ?>
                                <li class="site-menu-item">
                    ...
                    <?php if(Auth::user('merchant')->hasAnyPermission(['view_pricing_parameter','view_documents','view_vehicle_model','view_vehicle_make','view_countries','view_area','view_vehicle_type'])): ?>
                        ...
                        <?php if(Auth::user('merchant')->hasAnyPermission('view_pricing_parameter','view_documents','view_vehicle_model','view_vehicle_make','view_countries','view_area','view_vehicle_type')): ?>
                            <li class="site-menu-item has-sub">
                                ...
                                <ul class="site-menu-sub">
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($config->category_type_view) && $config->category_type_view == 1): ?>
                                        <li class="site-menu-item">
                                            <a class="animsition-link"
                                               href="<?php echo e(route('merchant.brands')); ?>">
                                                <span class="site-menu-title"><?php echo app('translator')->get("$string_file.brands"); ?></span>
                                            </a>
                                        </li>
                                        <li class="site-menu-item">
                                            <a class="animsition-link"
                                               href="<?php echo e(route('merchant.home-screen.design-config')); ?>">
                                                <span class="site-menu-title"><?php echo app('translator')->get("$string_file.home_screen_design_config"); ?></span>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php if((in_array('FOOD',$merchant_segment) || $food_clone|| in_array('DELIVERY',$merchant_segment)|| $grocery_clone) && (Auth::user('merchant')->hasAnyPermission(['DELIVERY','FOOD']) || Auth::user('merchant')->hasAnyPermission($all_grocery_clone) || Auth::user('merchant')->hasAnyPermission($all_food_clone))): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php if(in_array(1,$merchant_segment_group) || in_array(3, $merchant_segment_group)): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if(Auth::user('merchant')->can('view_pricing_parameter') && (in_array('TAXI',$merchant_segment) || in_array('DELIVERY',$merchant_segment) || in_array('CARPOOLING',$merchant_segment) ) && (Auth::user('merchant')->hasAnyPermission(['TAXI','DELIVERY','CARPOOLING']))): ?>
                                        <li class="site-menu-item">
                                    ...
                                    <?php endif; ?>
                                    <?php if(((isset($config->bank_details_enable) && $config->bank_details_enable == 1) || (isset($config->user_bank_details_enable) && $config->user_bank_details_enable == 1)) && Auth::user('merchant')->can('view-account-types')): ?>
                                        <li class="site-menu-item">
                        ...
                        <?php if(in_array('TAXI',$merchant_segment) && Auth::user('merchant')->can('TAXI')): ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if((Auth::user('merchant')->hasAnyPermission(['TAXI','DELIVERY','HANDYMAN','CARPOOLING']) || (Auth::user('merchant')->hasAnyPermission($all_food_grocery_clone))) && (in_array(1,$merchant_segment_group) || in_array(2,$merchant_segment_group) || in_array(3,$merchant_segment_group))): ?>
                            <li class="site-menu-item has-sub">
                                <a href="javascript:void(0)">
                                ...
                                <ul class="site-menu-sub">
                                    <?php if(in_array(1,$merchant_segment_group) || in_array(3,$merchant_segment_group)): ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if(in_array(3,$merchant_segment_group) && in_array('CARPOOLING',$merchant_segment)): ?>
                                            <li class="site-menu-item">
                                                <a class="animsition-link"
                                                   href="<?php echo e(route('carpooling.price_card')); ?>">
                                                    <span class="site-menu-title"><?php echo app('translator')->get("$string_file.carpooling"); ?> <?php echo app('translator')->get("$string_file.price_card"); ?></span>
                                                </a>
                                            </li>
                                        <?php endif; ?>
                                    <?php endif; ?>
                        ...
                        <?php if((in_array(2,$merchant_segment_group) || $grocery_clone) && (Auth::user('merchant')->can('HANDYMAN') || Auth::user('merchant')->hasAnyPermission($all_grocery_clone))): ?>
                            ...
                            <?php if(!empty($merchant->HandymanConfiguration) && $merchant->HandymanConfiguration->additional_charges_on_booking == 1): ?>
                                <li class="site-menu-item">
                    ...
                    <?php if(in_array('TAXI',$merchant_segment) && Auth::user('merchant')->can('TAXI') && (Auth::user('merchant')->hasAnyPermission(['manualdispach','ride_management_TAXI']))): ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <?php if(Auth::user('merchant')->hasAnyPermission(['view_drivers','create_drivers','basic_driver_signup','pending_drivers_approval','rejected_drivers','expired_driver_documents','view_pending_vehicle_apporvels','view_all_vehicles','view_driver_map','view_heat_map']) && $config->driver_enable == 1): ?>
                        <li class="site-menu-category"
                        ...
                        <?php if(Auth::user('merchant')->hasAnyPermission(['view_driver_map','view_heat_map'])): ?>
                            <li class="site-menu-item has-sub">
                                ...
                                <ul class="site-menu-sub">
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($config->real_time_map) && $config->real_time_map == 1): ?>
                                        <li class="site-menu-item">
                                            <a class="animsition-link" href="<?php echo e(route('realtime-driver-map')); ?>">
                                                <span class="site-menu-title"><?php echo app('translator')->get("$string_file.real_time_map"); ?></span>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                    ...
                    <?php if(Auth::user('merchant')->can('view_rider')): ?>
                        ...
                        <?php if(in_array('CARPOOLING',$merchant_segment)): ?>
                            <li class="site-menu-item has-sub">
                                <a href="javascript:void(0)">
                                    <i class="site-menu-icon fa-cab" aria-hidden="true"></i>
                                    <span class="site-menu-title"><?php echo app('translator')->get("$string_file.carpool_vehicles"); ?></span>
                                    <span class="site-menu-arrow"></span>
                                </a>
                                <ul class="site-menu-sub">
                                    <li class="site-menu-item">
                                        <a class="animsition-link"
                                           href="<?php echo e(route('merchant.uservehicles.allvehicles')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.all"); ?> <?php echo app('translator')->get("common.vehicles"); ?></span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link"
                                           href="<?php echo e(route('merchant.uservehicles.pending.vehicles')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.pending"); ?> <?php echo app('translator')->get("common.approval"); ?></span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(route('merchant.uservehicles.rejected')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.rejected"); ?> <?php echo app('translator')->get("common.vehicles"); ?></span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(route('merchant.uservehicles.deleted')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.deleted"); ?> <?php echo app('translator')->get("common.vehicles"); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <?php if(Auth::user('merchant')->hasAnyPermission(['view_refer','view_promotion','view_cms','view_child_terms','reward_points','view_language_strings','security_question','wallet_recharge','driver_commission_choices','view_payment_methods']) || $config->referral_code_enable == 1): ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <?php if(((in_array('FOOD',$merchant_segment) || in_array('GROCERY',$merchant_segment)) && Auth::user('merchant')->hasAnyPermission($grocery_food_exist)) || Auth::user('merchant')->can('view_driver_cash_out') || in_array('CARPOOLING',$merchant_segment)): ?>
                        <li class="site-menu-category"
                        ...
                        <li class="site-menu-item has-sub">
                            ...
                            <ul class="site-menu-sub">
                                ...
                                <?php if(in_array('CARPOOLING',$merchant_segment)): ?>
                                    <li class="site-menu-item">
                                        <a class="animsition-link"
                                           href="<?php echo e(route('merchant.carpool.user.transaction')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.user"); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                    ...
                    <?php if(Auth::user('merchant')->can('view_reports_charts')): ?>
                        ...
                        <li class="site-menu-item has-sub">
                            ...
                            <ul class="site-menu-sub">
                                ...
                                <?php if(in_array(3,$merchant_segment_group) && in_array('CARPOOLING',$merchant_segment)): ?>
                                    <li class="site-menu-item has-sub">
                                        <a href="<?php echo e(route('merchant.carpooling.earning')); ?>">
                                            <i class="site-menu-icon fa fa-lightbulb-o" aria-hidden="true"></i>
                                            <span class="site-menu-title"><?php echo app('translator')->get("$string_file.carpooling"); ?> <?php echo app('translator')->get("common.earning"); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        ...
                        <?php if(in_array('CARPOOLING',$merchant_segment)): ?>
                            <li class="site-menu-category"
                                id="carpooling-title"><?php echo app('translator')->get("$string_file.carpooling"); ?>   <?php echo app('translator')->get("common.configuration"); ?></li>
                            <!--<li class="site-menu-item">-->
                        <!--    <a class="animsition-link" href="<?php echo e(route('merchant.carpooling.earning')); ?>">-->
                            <!--        <i class="site-menu-icon far fa-money" aria-hidden="true"></i>-->
                        <!--        <span class="site-menu-title"><?php echo app('translator')->get("$string_file.carpooling"); ?>  <?php echo app('translator')->get("common.earning"); ?></span>-->
                            <!--    </a>-->
                            <!--</li>-->
                            <!--<li class="site-menu-item">-->
                        <!--    <a class="animsition-link" href="<?php echo e(route('merchant.carpooling.payment_configuration')); ?>">-->
                            <!--        <i class="site-menu-icon far fa-money" aria-hidden="true"></i>-->
                        <!--        <span class="site-menu-title"><?php echo app('translator')->get("common.payment"); ?> <?php echo app('translator')->get("common.configuration"); ?></span>-->
                            <!--    </a>-->
                            <!--</li>-->
                            <li class="site-menu-item">
                                <a class="animsition-link" href="<?php echo e(route('merchant.carpooling.config.country.id')); ?>">
                                    <i class="site-menu-icon far fa-plus" aria-hidden="true"></i>
                                    <span class="site-menu-title"> <?php echo app('translator')->get("common.country"); ?> <?php echo app('translator')->get("$string_file.carpooling"); ?> <?php echo app('translator')->get("common.configuration"); ?></span>
                                </a>
                            </li>
                            <li class="site-menu-item has-sub">
                                <a href="javascript:void(0)">
                                    <i class="site-menu-icon far fa-car" aria-hidden="true"></i>
                                    <span class="site-menu-title"><?php echo app('translator')->get("common.offer"); ?> <?php echo app('translator')->get("$string_file.ride"); ?> <?php echo app('translator')->get("common.management"); ?></span>
                                    <span class="site-menu-arrow"></span>
                                </a>
                                <ul class="site-menu-sub">
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(route('merchant.offer.rides')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.all"); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                        </a>
                                    </li>

                                    <li class="site-menu-item">
                                        <a class="animsition-link"
                                           href="<?php echo e(route('merchant.carpool.offer_up_coming.rides')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.up_coming"); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(route('merchant.offer_active.rides')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.on_going"); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(route('merchant.offer_complete.rides')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.complete"); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(route('merchant.offer_cancel.rides')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.cancel"); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                        </a>
                                    </li>
                            ...
                            <li class="site-menu-item has-sub">
                                <a href="javascript:void(0)">
                                    <i class="site-menu-icon fa-pencil-square" aria-hidden="true"></i>
                                    <span class="site-menu-title"><?php echo app('translator')->get("$string_file.ride"); ?> <?php echo app('translator')->get("common.management"); ?></span>
                                    <span class="site-menu-arrow"></span>
                                </a>
                                <ul class="site-menu-sub">

                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(route('merchant.carpool.up_coming.rides')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.up_coming"); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(route('merchant.active.rides')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.on_going"); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(route('merchant.complete.rides')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.complete"); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                        </a>
                                    </li>
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="<?php echo e(route('merchant.cancel.rides')); ?>">
                                            <span class="site-menu-title"><?php echo app('translator')->get("common.cancel"); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                        </a>
                                    </li>
                        ...
                        <?php if(((in_array('TAXI',$merchant_segment) || in_array('DELIVERY',$merchant_segment)) && Auth::user('merchant')->hasAnyPermission(['DELIVERY','TAXI','navigation_drawers'])) ||
                            ...
                            <li class="site-menu-item has-sub">
                                ...
                                <ul class="site-menu-sub">
                                    ...
                                    <?php endif; ?>
                                    <?php if(Auth::user('merchant')->hasAnyPermission(['DELIVERY','TAXI','HANDYMAN','CARPOOLING']) || Auth::user('merchant')->hasAnyPermission($all_food_grocery_clone)): ?>
                                        <li class="site-menu-item">
...
<?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/layouts/sidebar.blade.php ENDPATH**/ ?>