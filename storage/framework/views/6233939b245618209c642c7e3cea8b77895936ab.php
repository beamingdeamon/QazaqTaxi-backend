            ...
            <div class="panel panel-bordered">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">
                        <?php $heading = trans("$string_file.add");  $id = NULL; ?>
                        <?php if(isset($data['option']['id'])): ?>
                            <?php $heading = trans("$string_file.edit");$id = $data['option']['id']; ?>
                        <?php endif; ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/option-type/form.blade.php ENDPATH**/ ?>