                    ...
                    <div class="panel-actions">
                        ...
                        <?php if(Auth::user('merchant')->can('create_vehicle_type')): ?>
                            <button type="button" class="btn btn-icon btn-success float-right"
                                    title="<?php echo app('translator')->get("$string_file.add"); ?>"
                                    data-toggle="modal"
                        ...
                        <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('merchant.vehicletype.update.status',['id' => $vehicle->id,'status' => $status])); ?>"
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/vehicletype/index.blade.php ENDPATH**/ ?>