                            ...
                            <tr>
                                ...
                                <?php if(Auth::user('merchant')->can('edit_promotion') || Auth::user('merchant')->can('delete_promotion')): ?>
                                    <td>
                                        ...
                                        <?php endif; ?>
                                        <?php if(Auth::user('merchant')->can('delete_promotion') && $delete_permission): ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/promotion/index.blade.php ENDPATH**/ ?>