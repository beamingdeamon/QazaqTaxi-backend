            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    ...
                    <div class="row">
                        ...
                        <?php if(isset($data['arr_brands']) && !empty($data['arr_brands'])): ?>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="brand_id">
                                    <?php echo app('translator')->get("$string_file.brand"); ?>
                                </label>
                                <?php echo Form::select('brand_id',add_blank_option($data['arr_brands'],trans("$string_file.select")),old('brand_id ',isset($data['product']['brand_id']) ? $data['product']['brand_id'] : NULL),['id'=>'brand_id','class'=>'form-control','autocomplete'=>'off']); ?>

                                <?php if($errors->has('brand_id')): ?>
                                    <label class="text-danger"><?php echo e($errors->first('brand_id')); ?></label>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('business-segment.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/business-segment/product/form.blade.php ENDPATH**/ ?>