                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($change_status_permission): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php if(Auth::user('merchant')->can('delete_banner') && $delete_permission): ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/advertisement_banner/index.blade.php ENDPATH**/ ?>