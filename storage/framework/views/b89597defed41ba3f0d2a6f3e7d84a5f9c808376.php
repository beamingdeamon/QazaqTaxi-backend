        ...
        <div class="page-content">
            <?php if(session('vehiclemakeadded')): ?>
                <div class="alert dark alert-icon alert-info alert-dismissible"
                    ...
                    <i class="icon wb-info" aria-hidden="true"></i><?php echo app('translator')->get("$string_file.vehicle_make"); ?> <?php echo app('translator')->get("$string_file.added_successfully"); ?>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/vehiclemake/index.blade.php ENDPATH**/ ?>