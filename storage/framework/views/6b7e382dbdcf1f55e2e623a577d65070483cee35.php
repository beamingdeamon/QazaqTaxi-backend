                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::select("country_id",add_blank_option($countries),old("country_id"),["class"=>"form-control select2 search-input","id"=>"country_id","onchange"=>"getAreaList(this)"]); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::select("country_area_id",add_blank_option([]),old("country_area_id"),["class"=>"form-control select2 search-input","id"=>"country_area_id"]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/referral_system/create.blade.php ENDPATH**/ ?>