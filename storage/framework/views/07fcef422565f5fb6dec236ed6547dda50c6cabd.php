          ...
          <a class="nav-link" data-toggle="dropdown" href="javascript:void(0)" data-animation="scale-up"
            ...
            <?php if(isset($languages)): ?>
              <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(!empty($default_language) && strtolower($default_language) == strtolower($language->locale)): ?>
                  <?php echo e($language->name); ?>
...
</div><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/layouts/nav.blade.php ENDPATH**/ ?>