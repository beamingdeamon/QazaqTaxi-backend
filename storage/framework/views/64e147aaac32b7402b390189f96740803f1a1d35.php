    ...
    <div class="page">
        <div class="page-content">
            <?php if(session('success') || session('error')): ?>
                <div class="alert dark alert-icon <?php if(session('success')): ?> alert-success <?php else: ?> alert-danger <?php endif; ?> alert-dismissible"
                     role="alert">
            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification" enctype="multipart/form-data"
                          action="<?php echo e(route('taxicompany.book.manual.dispatch')); ?>" onsubmit="return validation()">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" id="segment" name="segment_id" value="<?php echo e($segment->id); ?>">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select class="form-control form-control" name="country"
                                                ...
                                                <option value=""><?php echo app('translator')->get("$string_file.select_country"); ?>
                                                </option>
                                    ...
                                    <div class="col-md-6 custom-hidden" id="first_name_new_div">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="new_user_first_name"
                                                   ...
                                                   placeholder="<?php echo app('translator')->get("$string_file.user_name"); ?>" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6 custom-hidden" id="last_name_new_div">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="new_user_last_name"
                                                   ...
                                                   placeholder="<?php echo app('translator')->get("$string_file.user_last_name"); ?>" autocomplete="off"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control" name="price_for_ride" id="price_for_ride">
                                                ...
                                                <option value="1" selected><?php echo app('translator')->get("$string_file.from_price_card"); ?></option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 custom-hidden" id="retrun_date_div">
                                        <div class="form-group">
                                            <label class="form-control-label" for="inputdatepicker"><?php echo app('translator')->get("$string_file.return"); ?>  <?php echo app('translator')->get("$string_file.date"); ?>
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                ...
                                                <input type="text" class="form-control customDatePicker1" id="datepicker" name="retrun_date"
                                                       placeholder="<?php echo app('translator')->get("$string_file.return"); ?>  <?php echo app('translator')->get("$string_file.date"); ?> " autocomplete="off" >
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <label class="form-control-label" for="ride_radius_driver_taxi_company"><?php echo app('translator')->get("$string_file.enter_radius"); ?> ( <?php echo app('translator')->get("$string_file.in_km"); ?> )
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="number" class="form-control" id="ride_radius_driver_taxi_company" name="ride_radius" required="" value="0.1"
                                       placeholder="<?php echo app('translator')->get("$string_file.phone"); ?>" min="0">
                                <label class="text-danger"><b id="number_of_drivers">0</b> <?php echo app('translator')->get("$string_file.drivers"); ?> (<?php echo app('translator')->get("$string_file.online_and_symbol_free"); ?> )</label>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="driver_id"><?php echo app('translator')->get("$string_file.select_driver"); ?>
                                        <span class="text-danger">*</span>
                                    </label>
                                    <select class="form-control form-control" name="driver_id"
                                            id="driver_id">
                                        <option value="">--<?php echo app('translator')->get("$string_file.select_driver"); ?>--</option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $('#check_user_details').click(function () {
            ...
            if (user_phone == "") {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "<?php echo e(route('taxicompany.SearchUser')); ?>",
        ...
        $("#ride_radius_driver_taxi_company").blur(function () {
            ...
            if (pickup_latitude == "" && drop_latitude == "") {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "<?php echo e(route('taxicompany.checkDriver')); ?>",
                    data: {
        ...
        function getService() {
            ...
            if (area_id != "" && vehicle_type_id != '') {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "<?php echo e(route('taxicompany.area.services')); ?>",
                    data: {
                        area_id: area_id,
                        merchant_id: "<?php echo e($taxicompany->merchant_id); ?>",
                        segment_id:1,
        ...
        function getMapDrivers(id) {
            ...
            $.ajax({
                ...
                method: 'POST',
                url: "<?php echo e(route('taxicompany.getDriverOnMap')); ?>",
                data: {
                    radius: radius,
                    manual_area: manual_area,
                    pickup_latitude: pickup_latitude,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('taxicompany.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qazaq/public_html/admin.qazaq.taxi/ms-v3/resources/views/taxicompany/manual/manual.blade.php ENDPATH**/ ?>