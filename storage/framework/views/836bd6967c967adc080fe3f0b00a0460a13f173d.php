<?php $__env->startSection('content'); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php else: ?>
                                              <?php echo Form::select('segment_id',add_blank_option($segment_list,trans("$string_file.select")),old('segment_id'),array('class' => 'form-control','required'=>true,'id'=>'segment_id','onChange'=>'getBusinessSegment()')); ?>
                             ...
                             <div class="col-md-4 <?php if(empty($promocode->id)): ?>custom-hidden <?php else: ?> <?php endif; ?>" id="business_segment">
                                <div class="form-group">
                                    <label for="">
                                    <?php echo app('translator')->get("$string_file.business_segment"); ?>
                                    </label>
                                    <?php if(!empty($id)): ?>
                                    <?php echo Form::text('business_seg_id',($promocode->business_segment_id) ? $promocode->BusinessSegment->full_name : "---",['class'=>"form-control",'disabled'=>true]); ?>

                                    <?php echo Form::hidden('business_segment_id',$promocode->business_segment_id,[]); ?>

                                    <?php else: ?>
                                    <?php echo e(Form::select('business_segment_id', [],old('business_segment_id', isset($promocode->business_segment_id ) ? $promocode->business_segment_id  : ''), ['class' => 'form-control', 'id' => 'business_segment_id'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="promocode"
                                               name="promocode" placeholder="FIRSTDELFREE"
    ...
    <script>
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('segment.get.business-segment')); ?>",
        }).done(function(data) {
            // if (data) {
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/promocode/create.blade.php ENDPATH**/ ?>