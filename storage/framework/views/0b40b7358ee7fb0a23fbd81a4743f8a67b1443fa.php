            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification"
                        ...
                        <?php if($driver_cashout_request->cashout_status == 0 && $edit_permission): ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/cashout/edit.blade.php ENDPATH**/ ?>