            ...
            <div class="mr--10 ml--10">
                ...
                <?php if(Auth::user('merchant')->can('dashboard')): ?>
                    <!-- Site Statistics -->
                                ...
                                <div class="panel panel-bordered">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <?php endif; ?>
                                            <?php if(Auth::user('merchant')->can('view_drivers') && $merchant->Configuration->driver_enable == 1): ?>
                                                <div class="col-xl-3 col-md-3 col-sm-6 info-panel">
                                            ...
                                            <?php endif; ?>
                                            <?php if(Auth::user('merchant')->can('expired_driver_documents') && $merchant->Configuration->driver_enable == 1): ?>
                        ...
                        <?php endif; ?>
                        <?php if(in_array(3,$merchant_segment_group_config)): ?>
                            ...
                            <div class="col-12 col-md-12 col-sm-12">
                                ...
                                <div class="panel panel-bordered">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title"><?php echo app('translator')->get("$string_file.carpooling"); ?> <?php echo app('translator')->get("common.statics"); ?></h3>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xl-3 col-md-3 col-sm-6 info-panel">
                                                <a href="<?php echo e(route('merchant.user.search',['type'=>1])); ?>">
                                                    <div class="card card-shadow" style="margin-bottom:0.243rem">
                                                        <div class="card-block bg-white p-20">
                                                            <button type="button"
                                                                    class="btn btn-floating btn-sm btn-primary"
                                                            ...
                                                            <span class="ml-10 font-weight-400"><?php echo app('translator')->get('common.offer'); ?> <?php echo app('translator')->get('common.user'); ?></span>
                                                            <div class="content-text text-center mb-0">
                                                                <span class="font-size-18 font-weight-100"><?php echo e($carpooling_states->offered_user); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="col-xl-3 col-md-3 col-sm-6 info-panel">
                                                <a href="<?php if(Auth::user('merchant')->can('view_drivers')): ?> <?php echo e(route('merchant.offer.rides')); ?><?php else: ?> # <?php endif; ?>">
                                                    <div class="card card-shadow" style="margin-bottom:0.243rem">
                                                        <div class="card-block bg-white p-20">
                                                            <button type="button"
                                                                    class="btn btn-floating btn-sm btn-success"
                                                            ...
                                                            <span class="ml-10 font-weight-400"><?php echo app('translator')->get('common.offer'); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                                            <div class="content-text text-center mb-0">
                                                                <span class="font-size-18 font-weight-100"><?php echo e($carpooling_states->offer_ride); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="col-xl-3 col-md-3 col-sm-6 info-panel">
                                                <a href="<?php if(Auth::user('merchant')->can('view_drivers')): ?> <?php echo e(route('merchant.offer_active.rides')); ?> <?php else: ?> # <?php endif; ?>">
                                                    <div class="card card-shadow" style="margin-bottom:0.243rem">
                                                        <div class="card-block bg-white p-20">
                                                            <button type="button"
                                                                    class="btn btn-floating btn-sm btn-primary"
                                                            ...
                                                            <span class="ml-10 font-weight-400"><?php echo app('translator')->get('common.on_going'); ?> <?php echo app('translator')->get('common.offer'); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                                            <div class="content-text text-center mb-0">
                                                                <span class="font-size-18 font-weight-100"><?php echo e($carpooling_states->on_going_ride); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="col-xl-3 col-md-3 col-sm-6 info-panel">
                                                <a href="<?php echo e(route('merchant.carpool.offer_up_coming.rides')); ?>">
                                                    <div class="card card-shadow">
                                                        <div class="card-block bg-white ml-20  p-20">
                                                            <button type="button"
                                                                    class="btn btn-floating btn-sm btn-warning"
                                                            ...
                                                            <span class="ml-10 font-weight-400"><?php echo app('translator')->get('common.up_coming'); ?> <?php echo app('translator')->get('common.offer'); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                                            <div class="content-text text-center mb-0">
                                                                <span class="font-size-18 font-weight-100"><?php echo e($carpooling_states->upcoming_ride); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="col-xl-3 col-md-3 col-sm-6 info-panel">
                                                <a href="<?php if(Auth::user('merchant')->can('view_drivers')): ?> <?php echo e(route('merchant.taken.rides')); ?> <?php else: ?> # <?php endif; ?>">
                                                    <div class="card card-shadow" style="margin-bottom:0.243rem">
                                                        <div class="card-block bg-white p-20">
                                                            <button type="button"
                                                                    class="btn btn-floating btn-sm btn-warning"
                                                            ...
                                                            <span class="ml-10 font-weight-400"><?php echo app('translator')->get('common.taken'); ?> <?php echo app('translator')->get("$string_file.ride"); ?></span>
                                                            <div class="content-text text-center mb-0">
                                                                <span class="font-size-18 font-weight-100"><?php echo e($carpooling_states->user_ride); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/home.blade.php ENDPATH**/ ?>