...
<div class="container content-width" style="background-color: #ffffff;max-width: 700px;min-width:300px;margin: 20px auto;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;">
    ...
    <div class="user-details" style="font-size: 13px; font-weight: 400;text-align: left;padding-left:25px; padding-right:25px;">
        ...
        <p><?php echo app('translator')->get("$string_file.mail_content_1"); ?> <?php echo e($order->Merchant->BusinessName); ?>! .<?php echo app('translator')->get("$string_file.mail_content_2_mail_content_3"); ?></p>
    </div>
...
</html><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/mail/order-invoice.blade.php ENDPATH**/ ?>