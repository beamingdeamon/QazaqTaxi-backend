                ...
                <div class="panel-body">
                    ...
                    <table class="display nowrap table table-hover table-striped w-full" id="customDataTable"
                        ...
                        <tr>
                            ...
                            <?php if($category_type_view): ?>
                                <th><?php echo app('translator')->get("$string_file.category_type_view"); ?></th>
                            <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <?php if($category_type_view): ?>
                                    <td>
                                        <span class="badge badge-success"><?php echo e($arr_category_type[$category->category_type]); ?></span>
                                    </td>
                                <?php endif; ?>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('business-segment.category.update.status',['id' => $category->id,'status' => $status])); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/category/index.blade.php ENDPATH**/ ?>