...
<footer class="site-footer">
    <div class="site-footer-legal">© <?php echo e(date('Y').' '.Auth::user('taxicompany')->name); ?></div>
...
<script src="<?php echo e(asset('js/my-script.js')); ?>" type="text/javascript"></script>s
...
</html><?php /**PATH /home/qazaq/public_html/admin.qazaq.taxi/ms-v3/resources/views/taxicompany/element/footer.blade.php ENDPATH**/ ?>