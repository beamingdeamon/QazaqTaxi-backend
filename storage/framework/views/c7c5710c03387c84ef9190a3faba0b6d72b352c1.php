                                                ...
                                                <?php $__currentLoopData = $driver->DriverDocument; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            ?>
                                                                <?php if($is_pdf): ?>
                                                                     <embed src="<?php echo e($p_doc); ?>" width="100px" height="100px" />
                                                                     <br>
                                                                     <a target="_blank" href="<?php echo e($p_doc); ?>"><?php echo app('translator')->get("$string_file.view"); ?></a>
                                                                <?php else: ?>
                                                        ...
                                                        <div class="col-md-6 col-sm-5">
                                                            ...
                                                            <div class="" style="width: 6.5rem;">
                                                                <div class=" bg-light">
                                                                    ...
                                                                    ?>
                                                                    <?php if($is_pdf): ?>
                                                                        <embed src="<?php echo e($vehicle_image); ?>" width="100px" height="100px" />
                                                                        <br>
                                                                        <a target="_blank" href="<?php echo e($vehicle_image); ?>"><?php echo app('translator')->get("$string_file.view"); ?></a>
                                                                    <?php else: ?>
                                                                        <a target="_blank" href="<?php echo e($vehicle_image); ?>">
                                                                            <img src="<?php echo e($vehicle_image); ?>" alt="avatar" style="width: 100px;height: 100px;">
                                                                        </a>
                                                                    <?php endif; ?>
                                                            ...
                                                            <?php if(!empty($document->temp_document_file)): ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        ...
                                                                        ?>
                                                                        <?php if($is_pdf): ?>
                                                                            <embed src="<?php echo e($file); ?>" width="100px" height="100px" />
                                                                            <br>
                                                                            <a target="_blank" href="<?php echo e($file); ?>"><?php echo app('translator')->get("$string_file.view"); ?></a>
                                                                        <?php else: ?>
                                                                            <a target="_blank" href="<?php echo e($file); ?>">
                                                                                <img src="<?php echo e($file); ?>" alt="avatar" style="width: 100px;height: 100px;">
                                                                            </a>
                                                                        <?php endif; ?>
                                                                ...
                                                                <?php if(!empty($document->temp_document_file)): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            ...
                                                                            ?>
                                                                            <?php if($is_pdf): ?>
                                                                                <embed src="<?php echo e($vehicle_file); ?>" width="100px" height="100px" />
                                                                                <br>
                                                                                <a target="_blank" href="<?php echo e($vehicle_file); ?>"><?php echo app('translator')->get("$string_file.view"); ?></a>
                                                                            <?php else: ?>
                                                                                <a target="_blank" href="<?php echo e($vehicle_file); ?>">
                                                                                    <img src="<?php echo e($vehicle_file); ?>" alt="avatar" style="width: 100px;height: 100px;">
                                                                                </a>
                                                                            <?php endif; ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/driver/show.blade.php ENDPATH**/ ?>