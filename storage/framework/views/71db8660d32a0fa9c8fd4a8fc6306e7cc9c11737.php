                ...
                <header class="panel-heading">
                    <div class="panel-actions">
                        ...
                        <?php if($carpooling_enable): ?>
                            <a href="<?php echo e(route('merchant.user.pending.vehicle.list')); ?>">
                                <button type="button"
                                        class="btn btn-icon btn-warning float-right" style="margin:10px">
                                    <?php echo app('translator')->get("common.pending"); ?> <?php echo app('translator')->get("common.user"); ?> <?php echo app('translator')->get("$string_file.vehicle"); ?> <?php echo app('translator')->get("common.approval"); ?>
                                    <span class="badge badge-pill"><?php echo e($pending_vehicle_users); ?>

                            </span>
                                </button>
                            </a>
                            <a href="<?php echo e(route('merchant.user.vehicle.rejected')); ?>">
                                <button type="button" class="btn btn-icon btn-danger float-right"
                                        style="margin:10px">
                                    <?php echo app('translator')->get("common.rejected"); ?> <?php echo app('translator')->get("common.user"); ?> <?php echo app('translator')->get("$string_file.vehicle"); ?>
                                    <span class="badge badge-pill"><?php echo e($rejected_user_vehicles); ?>
                                ...
                                <div class="col-md-2 col-xs-12 form-group active-margin-top">
                                    <div class="input-group">
                                        <select class="form-control" name="user_type"
                                                id="user_type">
                                            <option value="">--<?php echo app('translator')->get("common.user"); ?> <?php echo app('translator')->get("common.type"); ?>--</option>
                                            <option value="1"><?php echo app('translator')->get("common.offer"); ?> <?php echo app('translator')->get("common.user"); ?></option>
                                            <option value="2"><?php echo app('translator')->get("common.normal"); ?> <?php echo app('translator')->get("common.user"); ?></option>
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php endif; ?>
                                    <?php if(in_array('CARPOOLING',$segment)): ?>
                                        <br>
                                        <?php if(isset($user->total_offer_rides) && $user->total_offer_rides > 0): ?>
                                            <?php echo e($user->total_offer_rides); ?> <?php echo app('translator')->get("$string_file.offer"); ?>  <?php echo app('translator')->get("$string_file.rides"); ?>
                                        <?php else: ?>
                                            <?php echo app('translator')->get("$string_file.no"); ?> <?php echo app('translator')->get("$string_file.offer"); ?> <?php echo app('translator')->get("$string_file.ride"); ?>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <br>
                                ...
                                <td>
                                    <div class="button-margin">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('user.upload.document',$user->id)); ?>"
                                        ...
                                        <?php if(Auth::user('merchant')->can('edit_rider') && $change_status_permission): ?>
                                            <?php if($user->UserStatus == 1): ?>
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if(in_array('CARPOOLING',$segment)): ?>
                                                <a href="<?php echo e(route('merchant.user.vehicle_list',['id'=>$user->id])); ?>"
                                                   ...
                                                   class="btn btn-outline dropdown-item" role="menuitem">
                                                    ...
                                                    <b><?php echo app('translator')->get("$string_file.vehicle"); ?> <?php echo app('translator')->get("common.management"); ?></b></a>
                                            <?php endif; ?>
                                            <?php if(in_array('CARPOOLING',$segment)): ?>
                                                <a href="<?php echo e(route('merchant.user.address',['id'=>$user->id])); ?>"
                                                   data-original-title="Documents" data-placement="top"
                                                   class="btn btn-outline dropdown-item" role="menuitem">
                                                    <i class="icon fa fa-user"></i>
                                                    <b><?php echo app('translator')->get("common.user"); ?> <?php echo app('translator')->get("common.address"); ?></b></a>
                                            <?php endif; ?>
                                    </div>
                                </td>
                            </tr>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v3/resources/views/merchant/user/index.blade.php ENDPATH**/ ?>