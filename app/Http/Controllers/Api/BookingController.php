...
//            $booking->location = $location_object;
            ...
            $return_data = [
                ...
                "driver"=>[
                    ...
                    'profile_image'=>$booking->Driver->profile_image ? get_image($booking->Driver->profile_image, 'driver', $merchant_id, true, false) : view_config_image("static-images/driver_prfile.png"),
                ],
                "payment_method"=>[
...
//            $checkout->delete();
    ...
    public function checkoutPayment(Request $request)
    {
        ...
        try {
            ...
            if ($request->payment_method_id == 3 && ($estimate_amount > $newArray->User->wallet_balance)) {
...
//                        date_default_timezone_set($priceCard->CountryArea->timezone);
                    ...
                    $booking_transaction_submit->driver_total_payout_amount = $commission_data['driver_cut'] + $booking_transaction_submit->tip + $booking_transaction_submit->toll_amount;

                    // revenue of merchant
                    // Company Commission + Tax Amt - Discount + Insurance Amt + Booking Fee
                    $booking_transaction_submit->company_gross_total = $commission_data['company_cut'] + $booking_transaction_submit->tax_amount - $booking_transaction_submit->discount_amount + $booking_transaction_submit->insurance_amount + $booking_transaction_submit['cancellation_charge_received'] + $booking_transaction_submit->booking_fee;
