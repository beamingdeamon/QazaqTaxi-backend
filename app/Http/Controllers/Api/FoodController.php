...
//                    $this->getPopularBusinessSegment($request);
 ...
 $return_data = [];
            if ((!$request->has('page') || $request->page == 1) && $is_search != 1) {
                ...
                array_push($return_data,$popular_restaurant_heading,$popular_restaurant_res,$restaurant_heading,$restaurant_res); 
