...
//            Merchant::find($merchant_id);
        ...
        return view('merchant.driver.index', compact('booking_segment', 'order_segment', 'drivers', 'rejecteddrivers', 'pendingdrivers', 'basicDriver', 'config', 'tempDocUploaded', 'search_view', 'arr_search', 'socket_enable', 'info_setting','merchant'));
    }
...
//        $arr_commission_choice = $this->getDriverCommissionChoices($config);
        ...
        $info_setting = InfoSetting::where('slug', 'DRIVER')->first();
        return view('merchant.driver.create', compact('driver', 'areas', 'countries', 'group', 'config', 'account_types', 'driver_additional_data', 'personal_document', 'title', 'info_setting'));
    }
