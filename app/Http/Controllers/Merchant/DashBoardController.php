...
//    }
    ...
    //         "client_id"=> "08beae1c-5411-4192-a1df-61676633fc3b",
    //         "client_secret"=> "****************************",
...
//        $segment = App\Http\Controllers\Helper\Merchant::MerchantSegments();
        ...
        $total_earning=[];
        if (in_array('CARPOOLING', $merchant_segment)){
            $carpooling_total_earning =App\Models\CarpoolingRide::where([['merchant_id','=',$merchant_id],['ride_status','=',4]])->sum('company_commission');
        }
        $tax_amount=[];
        if (in_array('CARPOOLING', $merchant_segment)){
            $tax_amount =App\Models\CarpoolingRide::where([['merchant_id','=',$merchant_id],['ride_status','=',4]])->sum('service_charges');
        }
...
//            'carpooling_total_earning'=>$carpooling_total_earning,
...
//        p($home_delivery);
        ...
        return view('merchant.home', compact('site_states', 'taxi_states', 'merchant', 'handyman_booking_statistics', 'merchant_id', 'expire_driver_doc', 'corporates', 'home_delivery','countries','merchant_segment_group_config','carpooling_states'));
    }
