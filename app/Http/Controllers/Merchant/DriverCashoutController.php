...
//                CommonController::WalletCredit($driver->id,null,$driver_cashout_request->amount,10);
            ...
            $driver_cashout_request->comment = $request->comment;
            if($request->cashout_status == 1){
                if(isset($driver_cashout_request->credit_account_detail_id) && !empty($driver_cashout_request->credit_account_detail_id)){
                    ...
                    $result = $trans->makeTransfer($credit_account_detail, $driver_cashout_request->amount, $driver_cashout_request->transfer_transaction_id);
