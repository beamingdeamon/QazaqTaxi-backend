...
//            Merchant::with('Language')->find($merchant_id);
        ...
        return view('merchant.random.generalconfiguration', compact('service_types', 'configuration', 'languages', 'app_configuration','version_management','info_setting','is_demo','countries'));
    }
...
//                    'fare_policy_text' => $request->fare_policy_text,
    ...
    public function BookingConfiguration(Request $request)
    {
        ...
        return view('merchant.random.bookingconfiguration', compact('service_types', 'configuration', 'languages', 'paymentmethods', 'merchant', 'gen_config','merchant_segment_group_config','car_pooling_Configuration','merchant_segment','info_setting','is_demo'));
    }
