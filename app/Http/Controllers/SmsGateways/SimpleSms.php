...
class SimpleSms
{
    ...
    public function NsemfuaV3($apiKey, $sender, $phone, $message)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://web.nsemfua.com/api/v3/sms/send',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    public function SMSTeknik($username, $password, $id, $phone, $message){
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://api.smsteknik.se/send/xml/?id='.$id.'&user='.$username.'&pass='.$password,
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
    ...
    public function twilioWhatsapp($api_key, $secret_key, $sender, $phone, $message){
        $message = "Your package has been shipped. It will be delivered in 1234 business days.";
    ...
    public function Termii($apiKey, $sender, $phone, $message){
        ...
        $response = $client->sms->send($phone, $message);
        // dd($response);
        // return $response;
    }
    ...
    public function SMSUEHTP($apiKey, $secretKey, $phone, $message){
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://smsc.kz/sys/send.php?login=$apiKey&psw=$secretKey&phones=$phone&mes=$message",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    public function TeleSign($customer_id, $api_key, $phone, $message){
        // $customer_id = "ID4D9BC73E-3AC4-4AAD-9DA8-4A2D6332515A";
        // $api_key = "SQ+KmARFh5qucqCXi0oP+YP+LhR8obVcMWtffEEsO9ml1+rXsdbG7gzrCnatSy2YJz8k5JtZJRCJ0MSsxwqHrQ==";
        // $phone = "+595992265255";
        // $message = "sendonfg test msfh";
    ...
    //     $this->TeleSign('4D9BC73E-3AC4-4AAD-9DA8-4A2D6332515A','SQ+KmARFh5qucqCXi0oP+YP+LhR8obVcMWtffEEsO9ml1+rXsdbG7gzrCnatSy2YJz8k5JtZJRCJ0MSsxwqHrQ==','+595992265255','first testing message for otp verification');
    // }
}
