    ...
    public function SendSms($merchant_id, $phone, $otp, $event = null, $email = "")
    {
        ...
        if (!empty($phone) && !empty($SmsConfiguration->sms_provider)) {
            switch ($SmsConfiguration->sms_provider) {
                ...
                case "CMTELECOME":
                    $sendsms = new SimpleSms();
                    $sendsms->cmTelecome($SmsConfiguration->api_secret_key, $SmsConfiguration->sender, $phone, $message);
                case "NSEMFUA_V3":
                    $sendsms = new SimpleSms();
                    $sendsms->NsemfuaV3($SmsConfiguration->api_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "SPARROWSMS":
                    $sendsms = new SimpleSms();
                    $sendsms->SparrowSMS($SmsConfiguration->api_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "AAKASHSMSV3":
                    $sendsms = new SimpleSms();
                    $sendsms->AakashSMSV3($SmsConfiguration->auth_token, $phone, $message);
                    break;
                case "BULKSMSPLANS":
                    $sendsms = new SimpleSms();
                    $sendsms->BulkSMSPlans($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $SmsConfiguration->sender, $SmsConfiguration->sender_number, $phone, $message);
                    break;
                case "WEBLINE":
                    $sendsms = new SimpleSms();
                    $sendsms->WebLine($SmsConfiguration->auth_token, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "SMSTEKNIK":
                    $sendsms = new SimpleSms();
                    $sendsms->SMSTeknik($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "INTOUCHSMS":
                    $sendsms = new SimpleSms();
                    $sendsms->IntouchSMS($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "NALOSOLUTIONSMS":
                    $sendsms = new SimpleSms();
                    $sendsms->NaloSolutionsSMS($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "GEEZSMS":
                    $sendsms = new SimpleSms();
                    $sendsms->GeezSMS($SmsConfiguration->auth_token, $phone, $message,$SmsConfiguration->sender);
                    break;
                case "TWILIO_WHATSAPP":
                    $sendsms = new SimpleSms();
                    $sendsms->twilioWhatsapp($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "TERMII":
                    $sendsms = new SimpleSms();
                    $sendsms->Termii($SmsConfiguration->api_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "MOBIWEB":
                    $sendsms = new SimpleSms();
                    $sendsms->MobiWeb($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "SMS_ETHIOPIA":
                    $sendsms = new SimpleSms();
                    $sendsms->smsEthiopia($SmsConfiguration->auth_token, $SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $phone, $message);
                    break;
                case "ETECH":
                    $sendsms = new SimpleSms();
                    $sendsms->eTech($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "VONAGE_SMS":
                    $sendsms = new SimpleSms();
                    $sendsms->vonageSMS($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "TCAST_SMS":
                    $sendsms = new SimpleSms();
                    $sendsms->tCastSMS($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $SmsConfiguration->sender, $phone, $message);
                    break;
                case "ZOOMCONNECT":
                    $sendsms = new SimpleSms();
                    $sendsms->ZoomConnect($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $phone, $message);
                    break;    
                case "SMSUEHTP":
                    $sendsms = new SimpleSms();
                    $sendsms->SMSUEHTP($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $phone, $message);
                    break;
                case "TELESIGN":
                    $sendsms = new SimpleSms();
                    $sendsms->TeleSign($SmsConfiguration->api_key, $SmsConfiguration->api_secret_key, $phone, $message);
                    break;    
            }
        }
    }
