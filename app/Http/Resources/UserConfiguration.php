...
//                ($values['image'] == null) ? $values->AppNavigationDrawer->image : $values['image'];
        ...
        if(isset($this->logged_user_id) && !empty($this->logged_user_id)){
        ...
        $arr_payment_option = CommonController::filteredPaymentOptions($payment_option_list, $this->id);
...
//        }
        ...
        return [
            ...
            'ride_config' => [
                ...
                'home_screen_view' => $this->ApplicationConfiguration->home_screen_view,
            ],
            'general_config' => [
            ...
            'social' => [
                ...
                'google_signup_key' => $this->Configuration->google_signup_key ? $this->Configuration->google_signup_key : "",
                'facebook' => $this->Configuration->facebook == 1 ? true : false,
                'facebook_signup_key' => $this->Configuration->facebook_signup_key ? $this->Configuration->facebook_signup_key : "",
            ],
