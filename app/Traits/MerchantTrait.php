...
trait MerchantTrait{
    ...
    public function getMerchantSegmentServices($merchant_id,$call_from = '',$segment_group_id = NULL,$arr_segment = [],$country_area_id = NULL, $arr_segment_not_in = false,$arr_services = [],$sub_group_for_admin = NULL,$service_type = "ALL")
    {
//        p($service_type);
...
//        $query->where('is_coming_soon','!=',1);
        ...
        $arr_segment = $segment_services->map(function ($item) use ($merchant_id,$call_from,$country_area_id,$service_type) {
...
//                }
    ...
    function demoSpecialPermission($merchant_object = NULL, $merchant_id = NULL)
    {
        ...
        $is_demo = false;
        $data_permission = [];
        $edit_permission = true; $export_permission = true; $change_status_permission = true;$delete_permission = true; // default for non demo merchant @endphp
        ...
        if($is_demo)
        {
            $edit_permission = false;$export_permission = false; $change_status_permission = false; $delete_permission = false;// default for demo merchant without permission @endphp
