...
//                        ->join('handyman_orders as b', 'ho.driver_id', '=', 'b.id')
    ...
    public static function getPlumber($arr_reqest)
    {
        ...
        $id = $arr_reqest->id;
        $query = Driver::select('drivers.id', 'drivers.first_name', 'drivers.last_name', 'drivers.profile_image', 'drivers.created_at', 'drivers.email', 'drivers.phoneNumber', 'drivers.driver_additional_data', 'drivers.website_link', 'fd.is_favourite')
