...
class Booking extends Model
{
    ...
    public static function VehicleDetail($booking)
    {
        ...
        if (!empty($booking)) {
            ...
            $newObj['vehicle_image'] = $booking->DriverVehicle->vehicle_image ? get_image($booking->DriverVehicle->vehicle_image,'vehicle_document',$booking->merchant_id) : view_config_image("static-images/car-pool.png");
...
//         }
    ...
    {
        $booking = Booking::select('id','merchant_id','segment_id','user_id','driver_id','country_area_id','booking_status','payment_method_id')
