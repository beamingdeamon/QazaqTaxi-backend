                ...
                <table id="customDataTable" class="display nowrap table table-hover table-striped w-full"
                    ...
                    @foreach($complete_ride as $complete)
                        <tr>
                            ...
                            <td>
                                {{ucwords($complete->CarpoolingRide->user->first_name)." ".$complete->CarpoolingRide->user->last_name}}
                                <br>
                                {{$complete->CarpoolingRide->user->UserPhone ? : ''}}
                                <br>
                                {{$complete->CarpoolingRide->user->email ? : ''}}
                            </td>
