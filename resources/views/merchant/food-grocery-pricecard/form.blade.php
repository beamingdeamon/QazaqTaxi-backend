                            ...
                            <div class="row" id="row_id_{{$i}}">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        {!! Form::number('slab_amount[]',old('slab_amount[]',isset($detail['slab_amount']) ? $detail['slab_amount'] : ''),['class'=>'form-control','id'=>'slab_amount','required'=>$required,'min'=>0,'step'=>$data['step_value']]) !!}
