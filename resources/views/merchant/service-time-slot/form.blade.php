            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <section id="validation">
                        {!! Form::open(["class"=>"steps-validation wizard-notification","files"=>true,"url"=>route("segment.service-time-slot.save",$id)]) !!}
                        {!! Form::hidden('id',$id) !!}
                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                {{--                                    <div class="col-md-4">--}}
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <label>@lang("$string_file.service_type") <span class="text-danger">*</span>--}}
                                {{--                                            </label>--}}
                                {{--                                            <div class="form-group">--}}
                                {{--                                                {!! Form::select('service_type_id',$data['arr_services'],old('service_type_id',isset($data['service_time_slot']['service_type_id']) ? $data['service_time_slot']['service_type_id'] :NULL),['class'=>'form-control','required'=>true,'id'=>'service_type_id']) !!}--}}
                                {{--                                            </div>--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
