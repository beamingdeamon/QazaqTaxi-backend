...
// PayGo
Route::post('paygo-callback', 'PaymentMethods\PayGo\PayGoController@PayGoCallback')->name('paygo-callback');
...
// Midtrans Call Back
Route::any('/midtrans/{action}','PaymentMethods\Midtrans\MidtransController@callback');
...
//            Route::post('/cancel-order', ['as' => 'api.cancel-grocery-order', 'uses' => 'Api\GroceryController@cancelOrder']);
        ...
        // User vehicle api's
        Route::post('/vehicle-configuration', ['as' => 'api.user-vehicle-config', 'uses' => 'Api\DriverVehicleController@vehicleConfiguration']);
        ...
        Route::prefix('carpooling')->group(function () {
            Route::post('/start-offer-ride', ['as' => 'api.user.carpooling.startOfferRide', 'uses' => 'Api\CarpoolingController@startOfferRide']);
            Route::post('/pickup-offer-rde', ['as' => 'api.user.carpooling.pickUpUserRide', 'uses' => 'Api\CarpoolingController@pickUpUserRide']);
            Route::post('/end-user-ride', ['as' => 'api.user.carpooling.endUserRide', 'uses' => 'Api\CarpoolingController@endUserRide']);
            Route::post('/offer-ride-rating', ['as' => 'api.user.carpooling.offerRideRating', 'uses' => 'Api\CarpoolingController@offerRideRating']);
            Route::post('/taken-ride-rating', ['as' => 'api.user.carpooling.takenRideRating', 'uses' => 'Api\CarpoolingController@takenRideRating']);
            Route::post('/offer-ride-list', ['as' => 'api.user.carpooling.offerRideList', 'uses' => 'Api\CarpoolingController@offerRideList']);
            Route::post('/offer-ride-pickup', ['as' => 'api.user.carpooling.offerRidePickup', 'uses' => 'Api\CarpoolingController@offerRidePickup']);
            Route::post('/offer-ride-drop', ['as' => 'api.user.carpooling.offerRideDrop', 'uses' => 'Api\CarpoolingController@offerRideDrop']);
            Route::post('/taken-ride/view-request-detail', ['as' => 'api.user.carpooling.viewRideRequestDetail', 'uses' => 'Api\CarpoolingController@viewRideRequestDetail']);
            Route::post('/taken-ride-request', ['as' => 'api.user.carpooling.takenRideRequest', 'uses' => 'Api\CarpoolingController@takenRideRequest']);
            Route::post('/view-user-details', ['as' => 'api.user.carpooling.viewUserDetail', 'uses' => 'Api\CarpoolingController@viewUserDetail']);
            Route::post('/main-screen', ['as' => 'api.user.carpooling.mainscreen', 'uses' => 'Api\CarpoolingController@mainScreen']);
            Route::post('/ride-offer/step-one', ['as' => 'api.user-ride-offer-step-one', 'uses' => 'Api\CarpoolingController@offerRideCheckout']);
            Route::post('/ride-offer/step-two', ['as' => 'api.user-ride-offer-step-two', 'uses' => 'Api\CarpoolingController@offerRideDeleteDrop']);
            Route::post('/ride-offer/step-three', ['as' => 'api.user-ride-offer-step-three', 'uses' => 'Api\CarpoolingController@offerRideModifyCharges']);
            Route::post('/ride-offer/step-four', ['as' => 'api.user-ride-offer-step-four', 'uses' => 'Api\CarpoolingController@offerRideConfirm']);

            Route::post('/ride/search', ['as' => 'api.user-ride-search', 'uses' => 'Api\CarpoolingController@rideSearch']);
            Route::post('/ride/checkout', ['as' => 'api.user-ride-checkout', 'uses' => 'Api\CarpoolingController@rideCheckout']);
            Route::post('/ride/confirm', ['as' => 'api.user-ride-confirm', 'uses' => 'Api\CarpoolingController@rideConfirm']);


            Route::post('/offer-rides', ['as' => 'api.user-offer-rides', 'uses' => 'Api\CarpoolingController@offerRides']);
            Route::post('/offer-rides-details', ['as' => 'api.user-offer-rides.details', 'uses' => 'Api\CarpoolingController@offerRideDetails']);
            Route::post('/taken-rides', ['as' => 'api.user-taken-rides', 'uses' => 'Api\CarpoolingController@takenRides']);
            Route::post('/taken-rides-details', ['as' => 'api.user-taken-ride.details', 'uses' => 'Api\CarpoolingController@takenRideDetails']);
            Route::post('/taken-ride-cancel', ['as' => 'api.user-taken-ride.cancel', 'uses' => 'Api\CarpoolingController@cancelTakenRide']);
            Route::post('/offer-ride-cancel', ['as' => 'api.user-offer-ride.cancel', 'uses' => 'Api\CarpoolingController@CancelOfferRide']);
            Route::post('/offer-ride-taken-cancel', ['as' => 'api.user-offer-ride-taken.cancel', 'uses' => 'Api\CarpoolingController@offerRideTakenCancel']);
            Route::post('/offer-ride-cancel-reason', ['as' => 'api.user.offer-ride.cancel.reason', 'uses' => 'Api\CarpoolingController@offerRideCancelReason']);
            Route::post('/taken-ride-cancel-reason', ['as' => 'api.user.taken-ride.cancel.reason', 'uses' => 'Api\CarpoolingController@takenRideCancelReason']);
            Route::post('/user-receipt', ['as' => 'api.user-receipt', 'uses' => 'Api\CarpoolingController@userReceipt']);
            Route::post('/driver-receipt', ['as' => 'api.driver-receipt', 'uses' => 'Api\CarpoolingController@driverReceipt']);

//            Route::post('/offer-ride/start', ['as' => 'api.user.offer-ride.start', 'uses' => 'Api\CarpoolingController@RideStart']);
            Route::post('/ride-reach', ['as' => 'api.user.offer-ride.reach', 'uses' => 'Api\CarpoolingController@RideReach']);
            Route::post('/next-step', ['as' => 'api.user.next-ride.start', 'uses' => 'Api\CarpoolingController@nextStep']);
            Route::post('/ride-start-otp', ['as' => 'api.user.ride-start-otp', 'user' => 'Api\CarpoolingController@RideStartOtp']);

            Route::post('/pickup-users', ['as' => 'api.user.ride-user', 'uses' => 'Api\CarpoolingController@PickupUsers']);

            //past offer ride and past taken ride apis
            Route::post('/past-offer-rides', ['as' => 'api.user.past.offer-ride', 'uses' => 'Api\CarpoolingController@pastOfferRide']);
            Route::post('/past-taken-rides', ['as' => 'api.user.past.take-ride', 'uses' => 'Api\CarpoolingController@pastTakenRide']);
            Route::post('/past-offer-ride/search', ['as' => 'api.user.past-offer-ride.search', 'uses' => 'Api\CarpoolingController@PastOfferRideSearch']);
            Route::post('/past-take-ride/search', ['as' => 'api.user.past-take-ride.search', 'uses' => 'Api\CarpoolingController@takeRideSearch']);
            Route::post('/offer-drop-user', ['as' => 'api.user.offer.drop.user', 'uses' => 'Api\CarpoolingController@offerDropUser']);
            Route::post('/past-offer-ride-details', ['as' => 'api.user.past.offer-ride-detail', 'uses' => 'Api\CarpoolingController@pastOfferRideDetail']);
            Route::post('/past-taken-ride-details', ['as' => 'api.user.past.taken-ride-detail', 'uses' => 'Api\CarpoolingController@pastTakenRideDetail']);
            Route::post('/apply-remove-promo-code', ['as' => 'api.carpooling-promo-code', 'uses' => 'Api\CarpoolingController@ApplyRemovePromoCode']);
            Route::post('/wallet-hold-history', ['as' => 'api.carpooling-hold-wallet', 'uses' => 'Api\CarpoolingController@walletHoldHistory']);
            //customer support
            Route::post('/customer-support', ['as' => 'api.carpooling-customer-support', 'uses' => 'Api\CarpoolingController@customerSupport']);
        });
...
//        Route::post('/account/earning/details', ['as' => 'api.driver.account.earning.details', 'uses' => 'Api\DriverEarningController@AccountEarningHolder']);
        ...
        //EvMak
        Route::post('/send-request','PaymentMethods\EvMak\EvMakController@EvMakSendRequest');
        //send driver arriving reminder to user
