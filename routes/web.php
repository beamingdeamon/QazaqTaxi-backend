...
Route::prefix('merchant/admin')->group(function () {
    ...
    Route::group(['middleware' => ['auth:merchant', 'isactiveuser','admin_language']], function () {
        ...
        Route:: get('reward-system/{id}/delete', 'Merchant\RewardController@destroy')->name('merchant.rewardSystem.delete');
...
//        Route::get('/handyman/electrician/order/search', ['as' => 'handyman.electrician.order.search', 'uses' => 'Merchant\HandymanOrderController@electricianOrders']);
        ...
        //Reward Gift
        Route::get('/reward-gift',['as' => 'merchant.reward_gift.index', 'uses' => 'Merchant\RewardGiftController@index']);
        Route::delete('/reward-gift/destroy/{id}',['as' => 'reward_gift.destroy', 'uses' => 'Merchant\RewardGiftController@destroy']);
        Route::get('/reward-gift/add/{id?}', ['as'=>'reward_gift.add','uses'=>'Merchant\RewardGiftController@add']);
        Route::post('/reward-gift/save/{id?}', ['as'=>'reward_gift.save','uses'=>'Merchant\RewardGiftController@store']);
        Route::get('/reward-gift/updateStatus/{id}/{status}', ['as'=>'reward_gift.updateStatus','uses'=>'Merchant\RewardGiftController@updateStatus']);
        //Redeemed Reward Gift
        Route::get('/user-reward-gift',['as' => 'merchant.reward_gift.user_redeemed', 'uses' => 'Merchant\RewardGiftController@UserRedeemedReward']);
        Route::post('/user-reward/update-status',['as' => 'merchant.user.reward.updateStatus', 'uses' => 'Merchant\RewardGiftController@UserRedeemedRewardStatus']);
        Route::get('/driver-reward-gift',['as' => 'merchant.reward_gift.driver_redeemed', 'uses' => 'Merchant\RewardGiftController@DriverRedeemedReward']);
        Route::post('/driver-reward/update-status',['as' => 'merchant.driver.reward.updateStatus', 'uses' => 'Merchant\RewardGiftController@DriverRedeemedRewardStatus']);
    });
});
...
//        Route::get('/cancelled-order/search',['as'=>'business-segment.cancelled-order.search','uses'=>'BusinessSegment\OrderController@getCancelledOrder']);
        ...
        // self pickup server routes
        Route::get('/order/accept/{id}',['as'=>'business-segment.order.accept','uses'=>'BusinessSegment\OrderController@acceptOrder']);
        Route::get('/pending-order-delivery',['as'=>'business-segment.pending-order-delivery','uses'=>'BusinessSegment\OrderController@pendingOrderDelivery']);
        Route::get('/deliver/order/{id}',['as'=>'business-segment.deliver-order','uses'=>'BusinessSegment\OrderController@deliverOrder']);
        Route::post('/deliver/order-request/{id}',['as'=>'business-segment.deliver-order-request','uses'=>'BusinessSegment\OrderController@deliverOrderRequest']);
